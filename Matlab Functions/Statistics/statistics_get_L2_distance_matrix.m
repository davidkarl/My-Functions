function d = statistics_get_L2_distance_matrix(a,b,flag_force_diagonals_to_be_zero)
...
if (nargin < 3)
    flag_force_diagonals_to_be_zero = 0;    % by default, do not force 0 on the diagonal
end
...
if (flag_force_diagonals_to_be_zero==1)
    d = d.*(1-eye(size(d)));
end
