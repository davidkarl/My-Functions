function parameters = noise_estimation_DIMCRA(current_frame_ps,parameters)
...
current_raw_ps_to_smoothed_ps_minB_aposteriori_SNR_threshold = parameters.gamma0;
smoothed_raw_ps_to_smoothed_ps_minB_aposteriori_SNR_threshold = parameters.psi0;
...
%OMLSA stuff:
indices_to_look_for_low_frequencies_speech_activity_min = parameters.indices_to_look_for_low_frequencies_speech_activity_min;
indices_to_look_for_low_frequencies_speech_activity_max = parameters.indices_to_look_for_low_frequencies_speech_activity_max;
P_min_low_frequencies_mean_speech_probability_threshold = parameters.P_min_low_frequencies_mean_speech_probability_threshold;
P_min = parameters.P_min;
less_smoothed_raw_ps = parameters.less_smoothed_raw_ps;
xi_smoothing_factor = parameters.xi_smoothing_factor;
smoothed_xi_estimate = parameters.smoothed_xi_estimate;
flag_remove_interfering_tonals = parameters.flag_remove_interfering_tonals;


%stored specral minimas:
stored_raw_window_averaged_ps_smoothed_min = parameters.stored_min;
stored_raw_window_averaged_ps_smoothed_min2 = parameters.stored_min2;
stored_noise_window_averaged_ps_smoothed_min = parameters.stored_min_tild;
stored_noise_window_averaged_ps_smoothed_min2 = parameters.stored_min_tild2;

raw_frequency_smoothed_ps_time_smoothed_min = parameters.raw_frequency_smoothed_ps_time_smoothed_min;
raw_frequency_smoothed_ps_time_smoothed_min2 = parameters.raw_frequency_smoothed_ps_time_smoothed_min2;
raw_frequency_smoothed_ps_time_smoothed_min_sw = parameters.raw_frequency_smoothed_ps_time_smoothed_min_sw;
raw_frequency_smoothed_ps_time_smoothed_min_sw2 = parameters.raw_frequency_smoothed_ps_time_smoothed_min_sw2;

raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min = parameters.raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min;
raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min2 = parameters.raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min2;
raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min_sw = parameters.raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min_sw;
raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min_sw2 = parameters.raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min_sw2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
current_ps_to_smoothed_ps_minimum_aposteriori_SNR_gamma_min = current_frame_ps ./ (minimum_ps_correction_factor*max(10^-10,raw_frequency_smoothed_ps_time_smoothed_min));
smoothed_ps_to_smoothed_ps_minimum_aposteriori_SNR_psi_min = raw_frequency_smoothed_ps_time_smoothed ./ (minimum_ps_correction_factor*max(10^-10,raw_frequency_smoothed_ps_time_smoothed_min));
...
current_ps_to_smoothed_ps_minimum_aposteriori_SNR_gamma_min2 = current_frame_ps ./ (minimum_ps_correction_factor*max(10^-10,raw_frequency_smoothed_ps_time_smoothed_min2));
smoothed_ps_to_smoothed_ps_minimum_aposteriori_SNR_psi_min2 = raw_frequency_smoothed_ps_time_smoothed2 ./ (minimum_ps_correction_factor*max(10^-10,raw_frequency_smoothed_ps_time_smoothed_min2));
...
current_raw_ps_to_smoothed_noise_ps_minB_aposteriori_SNR = current_frame_ps ./ (minimum_ps_correction_factor*max(10^-10,raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min));
smoothed_ps_to_smoothed_noise_ps_minB_aposteriori_SNR = raw_frequency_smoothed_primarily_noise_ps_time_smoothed ./ (minimum_ps_correction_factor*max(10^-10,raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min));
...
current_raw_ps_to_smoothed_noise_ps_minB_aposteriori_SNR2 = current_frame_ps ./ (minimum_ps_correction_factor*max(raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min2,10^-10));
smoothed_ps_to_smoothed_noise_ps_minB_aposteriori_SNR2 = raw_frequency_smoothed_primarily_noise_ps_time_smoothed2 ./ (minimum_ps_correction_factor*max(raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min2,10^-10));
...
if flag_remove_interfering_tonals==1  
    ...
    minimum_attenuation_correction_factor = 1;   
end 
...
parameters.stored_min2 = stored_raw_window_averaged_ps_smoothed_min2;
parameters.stored_min_tild2 = stored_noise_window_averaged_ps_smoothed_min2;

parameters.raw_frequency_smoothed_ps_time_smoothed_min = raw_frequency_smoothed_ps_time_smoothed_min;
parameters.raw_frequency_smoothed_ps_time_smoothed_min2 = raw_frequency_smoothed_ps_time_smoothed_min2;
parameters.raw_frequency_smoothed_ps_time_smoothed_min_sw = raw_frequency_smoothed_ps_time_smoothed_min_sw;
parameters.raw_frequency_smoothed_ps_time_smoothed_min_sw2 = raw_frequency_smoothed_ps_time_smoothed_min_sw2;

parameters.raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min = raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min;
parameters.raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min2 = raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min2;
parameters.raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min_sw = raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min_sw;
parameters.raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min_sw2 = raw_frequency_smoothed_primarily_noise_ps_time_smoothed_min_sw2;
...
parameters.noise_tild = final_noise_ps_before_beta_correction_previous;
parameters.noise_ps = final_noise_ps_after_beta_correction_previous;
...
parameters.apriori_speech_presence_probability = p_apriori_speech_presence_probability;
parameters.less_smoothed_raw_ps = less_smoothed_raw_ps;
parameters.minimum_attenuation_correction_factor = minimum_attenuation_correction_factor;
