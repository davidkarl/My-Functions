...
noise_estimation_method='connected_time_frequency_regions';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    flag_first_loop = 1;
    noise_gate_threshold_vec = mean(phase_signal_spectrum_matrix,2);
    while sub_frame_counter < global_to_sub_frame_size_ratio*2
        ...
        noise_estimation_method='imcra';
        if flag_first_loop
            noise_estimation_parameters = initialise_noise_estimation_parameters(current_sub_frame_spectrum,Fs,noise_estimation_method);
            flag_first_loop = 0;
        else
            noise_estimation_parameters = audio_estimate_noise_profile_parameters(current_sub_frame_spectrum,noise_estimation_method,noise_estimation_parameters);
        end
