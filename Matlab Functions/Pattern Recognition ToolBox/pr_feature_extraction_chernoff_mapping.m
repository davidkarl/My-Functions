...
%	R   Regularisation variable, 0 <= r <= 1, default is r = 0, for r = 1 the 
...
% subspace such that it maximises the heteroscedastic Chernoff criterion
...
function W = pr_feature_extraction_chernoff_mapping(a,n,r)
