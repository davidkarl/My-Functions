...
%   D1       Difference in mean in feature 1 (default: 2)
%   D2       Difference in mean in feature 2 (default: 1)
...
function A = pr_generate_dataset_difficult_multivariate_2_class_gaussians(N,k,d1,d2,labtype)

		
	if nargin < 5, labtype = 'crisp'; end
	if nargin < 4 || isempty(d2), d2 = 1; end
	if nargin < 3 || isempty(d1), d1 = 2; end
	...
	A = prdataset(A,lab,'name','Difficult Dataset','lablist',char('1','2'),'prior',p);
