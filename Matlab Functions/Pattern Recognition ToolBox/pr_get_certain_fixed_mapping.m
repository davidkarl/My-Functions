...
function w = pr_get_certain_fixed_mapping(arg1,arg2,par1,par2,par3)
		...
		if (isstr(arg2))								
          ...
          w = setlabels(w);           % avoid feature labels
			...
			if (min(size(arg2)) == 1)
				...
				prwarning(3,'second input argument is a vector: performing feature selection');
				...
				prwarning(3,'second input argument is a matrix: performing polynomial mapping');
