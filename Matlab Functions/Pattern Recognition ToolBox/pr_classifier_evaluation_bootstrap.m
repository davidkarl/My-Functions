...
function e = pr_classifier_evaluation_bootstrap(a,classf,learnsizes,nreps) 
  ...
  if isempty(learnsizes)
    error('No feasible learnsizes found. Some class sizes are too small')
  end
