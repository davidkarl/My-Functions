...
function v = pr_transform_density_classifier_to_log_density_classifier(w)
	...
	if (nargin < 1 | isempty(w))
		...
		elseif isuntrained(w)
			v = prmapping('sequential','untrained',{w,pr_transform_density_classifier_to_log_density_classifier});
		else
