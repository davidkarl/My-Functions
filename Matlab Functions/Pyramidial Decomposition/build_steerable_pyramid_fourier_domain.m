function [pyramid,index_matrix,steering_matrix,harmonics] = build_steerable_pyramid_fourier_domain(...
...
%
%    + Reconstruction is exact (within floating point errors) WHY IS IT NOT WITH THE REGULAR STEERABLE PYRAMID
...
[pyramid,index_matrix] = construct_steerable_pyramid_fourier_level_recursively(lo0dft, log_rad, Xrcos, Yrcos, angle, height, number_of_bands);
