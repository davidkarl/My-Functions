function [y_signal_estimate,residual_error_over_time] = kalman_filter_filtering_bidirectional2(input_signal,...
    state_transition_matrix,H_measurement_matrix,Q_process_noise_covariance,R_measurement_noise_covariance) 
