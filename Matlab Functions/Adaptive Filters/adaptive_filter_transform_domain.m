...
function    [filter_output_over_time,filter_error_over_time,filter_coefficients_over_time_in_T_domain,filter_coefficients_over_time] = ...
...
filter_coefficients_over_time = T'*filter_coefficients_over_time_in_T_domain;
