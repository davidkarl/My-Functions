function    [filter_output_over_time,filter_error_over_time,filter_coefficients_over_time] = ...
    adaptive_filter_signed_data(desired_signal,input_signal,filter_order,initial_coefficients,mu_convergence_factor)
...
for iteration_counter = 1:N_number_of_iterations,
    ...
    %calculate next coefficients vector using signed data rule:
    next_coefficients = current_coefficients + ...
                                    (2 * mu_convergence_factor * current_filter_error * sign(current_signal));
