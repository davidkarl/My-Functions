function [output_signal_final, ...
          ...
          theta_total_coefficients] = adaptive_filter_IIR_RLS_gauss_newton_stabilized(...
...
total_number_of_coefficients           = numerator_order + 1 + denominator_order;  
...
x_input_signal = [zeros(numerator_order,1) , transpose(input_signal)]; 
   ...
   PhiVector   = [ +y_derivative_vec(1:denominator_order) ; -x_derivative_vec(1:numerator_order+1) ];
    ...
    theta_total_coefficients(:,iterations_counter+1) = ...
                    theta_total_coefficients(:,iterations_counter) - ...
                       mu_step_size * PhiVector * filter_error_over_time(iterations_counter);                      
