...
Sd_inverse_R                     = zeros(total_number_of_coefficients,total_number_of_coefficients);
...
for iterations_counter = 1:number_of_iterations
   ...
   Sd_inverse_R = inv(lambda_smoothing_factor)*...
               ...
               (lambda_smoothing_factor + PhiVector.'*Sd_inverse_R*PhiVector));
            
   
    % Update Coefficients
    theta_total_coefficients(:,iterations_counter+1) = ...
                    theta_total_coefficients(:,iterations_counter) - ...
                              Sd_inverse_R * PhiVector * filter_error_over_time(iterations_counter);                      
