function [cropped_filters, filters_non_zero_indices] = get_filters_and_indices_which_are_above_tolerance(filters,tolerance)
...
%
    ...
    for k = 1:number_of_filters
        indices = get_filters_row_and_column_indices_above_tolerance(filters{k},tolerance);
