function [kernel] = get_filter_by_name(filter_name)
...
if strcmp(filter_name(1:min(5,size(filter_name,2))), 'binom')
  kernel = sqrt(2) * binomialFilter(str2num(filter_name(6:size(filter_name,2))));
elseif strcmp(filter_name,'qmf5')
  kernel = [-0.076103 0.3535534 0.8593118 0.3535534 -0.076103]';
elseif strcmp(filter_name,'qmf9')
  kernel = [0.02807382 -0.060944743 -0.073386624 0.41472545 0.7973934 ...
      0.41472545 -0.073386624 -0.060944743 0.02807382]';
elseif strcmp(filter_name,'qmf13')
...
elseif strcmp(filter_name,'qmf16')
...
elseif strcmp(filter_name,'gauss5')  % for backward-compatibility
  kernel = sqrt(2) * [0.0625 0.25 0.375 0.25 0.0625]';
elseif strcmp(filter_name,'gauss3')  % for backward-compatibility
