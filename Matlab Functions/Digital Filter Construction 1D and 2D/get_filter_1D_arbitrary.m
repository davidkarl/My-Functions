function [actual_filter] = ...
    get_filter_1D_arbitrary(filter_order,Fs,frequency_vec,amplitude_gains_dB,window_name) 
...
actual_filter = dfilt.dffir(filter_ceofficients);
