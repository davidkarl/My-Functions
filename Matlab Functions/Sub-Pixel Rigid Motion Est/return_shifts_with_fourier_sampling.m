function [col_shift,row_shift,CCmax] = return_shifts_with_fourier_sampling(mat1,mat2,spacing,accuracy)
  
    N=size(mat1,1); %assuming both are the same size and square matrices
